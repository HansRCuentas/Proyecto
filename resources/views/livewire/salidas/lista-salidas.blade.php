<div>
    @section('title', 'ListaSalidas')
    <h1><b>Lista de Salidas Materia Prima</b></h1>
    <div class="card">
        <div class="card-body">
            <div class="form-row">
                ...
                <div class="form-group col-md-2">
                    <a class="btn btn-danger form-control" href="{{route('registro_salidas')}}">Registrar Salida</a>
                </div>
            </div>
            @if (count($salidas))
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="row d-block">
                                    <a class="btn btn-danger" wire:click="$emit('eliminarSalida',{{$item->id}})"><i class="fa-solid fa-trash"></i></a>
                                </div>
                            </td>
                        </tr>
                        @endforeach
    ...
    <script>
        Livewire.on('eliminarSalida', catId => {
            Swal.fire({
                title: 'Esta seguro de eliminar la Salida de Productos?',
                ...
                if (result.isConfirmed) {
                    Livewire.emitTo('salidas.lista-salidas', 'eliminar', catId)
                    Swal.fire(
                        'Eliminado!',
                        'La salida de productos ha sido eliminada',
                        'success'
                    )
                }
            })

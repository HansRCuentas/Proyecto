<div>
    ...
    <h1><b>Registro Ingreso de Productos Terminados</b></h1>
    <div class="card">
        <div class="card-body">
            <div class="form-row">
                ...
                <table class="table table-striped table-hover table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control bg-secondary" type="number" value="{{$cantidadTotal}}" readonly>
            ...
            <div class="form-row justify-content-center">
                ...
                <button class="btn btn-success ml-2" wire:click="guardarIngreso">Registrar Ingreso</button>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body container">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-3">
                                <label for="cantidadp">Cantidad Ingresar</label>

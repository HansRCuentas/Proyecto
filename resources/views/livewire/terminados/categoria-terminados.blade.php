<div>
    @section('title', 'CategoriasPT')
    <h1><b>Categorias | Productos Terminados</b></h1>
    <div class="card">
        <div class="card-body">
            <div class="form-row">
                ...
                <div class="form-group col-md-2">
                    @livewire('terminados.crear-categoria')
                </div>
            </div>
            @if (count($categorias))
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body" wire:loading.remove wire:target="editar">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nombre" wire:model.defer="nombret">
                                @error('nombret')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="disabled form-control" id="descripcion" wire:model.defer="descripciont">
        ...
        Livewire.on('eliminarCat', catId => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Livewire.emitTo('terminados.categoria-terminados', 'eliminar', catId)
                    Swal.fire(
                        'Eliminado!',

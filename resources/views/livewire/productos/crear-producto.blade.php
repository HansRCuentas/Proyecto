                ...
                <div class="modal-body">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" class="form-control" placeholder="0" id="stock" wire:model.defer="stock">
                            @error('stock')
                            <small class="form-text text-danger">{{$message}}</small>
                            @enderror
                        </div>
                        <div class="form-group col-md-6">
                            <label for="costo">Stock Minimo</label>
                            <input type="number" class="form-control" placeholder="0" id="costo" wire:model.defer="stock_minimo">
                            @error('stock_minimo')
                            <small class="form-text text-danger">{{$message}}</small>
                            @enderror
                        </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" class="form-control" id="costo" placeholder="0" wire:model.defer="costo_producto">
